...
@RestController
@RequestMapping("/reporteOperacionesGerente")
...
public class VisOperacionesGerenteController {
	
	private final IVisOperacionesGerente service;

	public VisOperacionesGerenteController(IVisOperacionesGerente service) {
		this.service = service;
	}

	
	@Operation(description = "Obtiene el Reporte Operaciones Gerente")
	@GetMapping("/")
	public ResponseEntity<ReporteOperacionesGerente> generarReporte(
			...
			return listarPaginado(fechaInicial, fechaFinal,  registroInicial,numeroRegistros);
				
	}

	private ResponseEntity<ReporteOperacionesGerente> listarPaginado(LocalDate fechaInicial, LocalDate fechaFinal,int registroInicial, int numeroRegistros) {
		ReporteOperacionesGerente reporte=service.listarPaginado(fechaInicial, fechaFinal, registroInicial, numeroRegistros);
